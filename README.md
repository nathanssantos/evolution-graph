...
| :----------------------------------------- | :--------- | :------------------------------------------------------------------ |
| `renderValue: (value:`_String_`) => value` | _Function_ | Can be used for label handling. See **Usage** for an example.       |
| `onChange: (step:`_Number_`) => step`      | _Function_ | Called when the current step changes. See **Usage** for an example. |

## Actions

| Prop                              | Type       | Description                                                                  |
| :-------------------------------- | :--------- | :--------------------------------------------------------------------------- |
| `create(selector:`_String_`)`     | _Function_ | Create and append a graph as selector's child. See **Usage** for an example. |
| `setCurrentStep(step:`_Number_`)` | _Function_ | Set the current evolution step by index.                                     |
